...
(defvar atom-one-dark-colors-alist
  '(("atom-one-dark-accent"   . "#528BFF")
    ("atom-one-dark-fg"       . "#FFFFFF")
    ("atom-one-dark-bg"       . "#0C1021")
    ("atom-one-dark-bg-1"     . "#121417")
    ("atom-one-dark-bg-hl"    . "#2F343D")
    ("atom-one-dark-mono-1"   . "#FFAAAA")
    ("atom-one-dark-mono-2"   . "#FFFFFF")
    ("atom-one-dark-mono-3"   . "#AEAEAE")
    ("atom-one-dark-cyan"     . "#0080FF")
    ("atom-one-dark-blue"     . "#9999ff")
    ("atom-one-dark-purple"   . "#FBDE2D")
    ("atom-one-dark-green"    . "#61CE3C")
    ("atom-one-dark-red-1"    . "#FF6400")
    ("atom-one-dark-red-2"    . "#FF0000")
    ("atom-one-dark-orange-1" . "#4477DD") 
    ("atom-one-dark-orange-2" . "#FF6400")
    ("atom-one-dark-gray"     . "#253B76")
    ("atom-one-dark-silver"   . "#AEAEAE")
